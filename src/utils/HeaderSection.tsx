const HeaderSection = ({ title, des }: { title: string; des: string }) => {
  return (
    <div className="max-w-4xl flex flex-col justify-center items-center mx-auto px-6 sm:px-0">
      <img className="w-15 h-11" src="https://i.ibb.co/JCmpdjc/png-transparent-reforestation-tree-planting-nursery-logo-tree-leaf-plant-stem-grass-removebg-preview.png" alt="body-logo" />
